...
public class UVicTest {
    ...
    public void setUp() {
        // Chrome
        System.setProperty("webdriver.chrome.driver", "/Users/Leo/Document/SENG275_202205/chromedriver");
    ...
    public void uvicSearchBoxAppears() {
        browser.get("https://www.uvic.ca");
        WebElement searchButton = browser.findElement(By.xpath("/html/body/header/div[1]/div[2]/div/div/div[2]/input[1]"));
        searchButton.click();
    ...
    public void uvicSearchResultsAppear() {
        ...
        new WebDriverWait(browser, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/header/div[1]/div[1]/div/div/form/div/input[2]")));
        WebElement search = browser.findElement(By.xpath("/html/body/header/div[1]/div[1]/div/div/form/div/button"));
        searchBar.sendKeys("csc");
        search.click();

        new WebDriverWait(browser, 10).until(ExpectedConditions.titleIs("Search - University of Victoria"));
